...
<body>
	...
	<div id="contact-page" class="container">
    	<div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">    			   			
					<h2 class="title text-center">Contact <strong></strong></h2>    			    				    				
    		...
    		<div class="row">  	
	    		...
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				...
	    				<address>
	    					<p>E-Solde Maroc.</p>
							<p>Rue Rakib Med Al Moussaoui, Casablanca, Maroc</p>
							<p>Maroc</p>
							<p>Mobile: +212 635 405 251</p>
							<p>Fax: +212 510 524 214</p>
							<p>Email: zakariahili@gmail.com</p>
	    				</address>
