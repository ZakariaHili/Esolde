								...
								<div class="col-sm-12 col-md-pull-1">
									...
									<f:form class="form-horizontal" role="form" action="SaveCompte"
										...
										<div class="col-sm-offset-3 ">
											...
											<f:errors path="Num_Tel_representant"></f:errors>
										</div>
										...
										<div class="form-group">
											<label class="control-label col-sm-3" for="text">Tel:</label>
											<div class="input-group col-md-3">
												<input type="text" class="form-control col-sm-3" id="text"
													name="Num_Tel_representant"
													placeholder="${Representant.getNum_Tel_representant() }">
											</div>
										</div>
